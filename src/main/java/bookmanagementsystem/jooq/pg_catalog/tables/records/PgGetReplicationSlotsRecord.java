...
public class PgGetReplicationSlotsRecord extends TableRecordImpl<PgGetReplicationSlotsRecord> {
    ...
    /**
     * Setter for <code>pg_catalog.pg_get_replication_slots.failover</code>.
     */
    ...
    /**
     * Getter for <code>pg_catalog.pg_get_replication_slots.failover</code>.
     */
    ...
    /**
     * Setter for <code>pg_catalog.pg_get_replication_slots.synced</code>.
     */
    ...
    /**
     * Getter for <code>pg_catalog.pg_get_replication_slots.synced</code>.
     */
     ...
     */
    public PgGetReplicationSlotsRecord(String slotName, String plugin, String slotType, Long datoid, Boolean temporary, Boolean active, Integer activePid, Long xmin, Long catalogXmin, Object restartLsn, Object confirmedFlushLsn, String walStatus, Long safeWalSize, Boolean twoPhase, OffsetDateTime inactiveSince, Boolean conflicting, String invalidationReason, Boolean failover, Boolean synced) {
        super(PgGetReplicationSlots.PG_GET_REPLICATION_SLOTS);
