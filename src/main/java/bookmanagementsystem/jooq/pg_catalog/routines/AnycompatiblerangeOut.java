...
public class AnycompatiblerangeOut extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anycompatiblerange\""), false, true);
    ...
    public AnycompatiblerangeOut() {
        super("anycompatiblerange_out", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
