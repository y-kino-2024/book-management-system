...
public class IntervalSum extends AbstractRoutine<YearToSecond> {

    /**
     * The parameter <code>pg_catalog.interval_sum.RETURN_VALUE</code>.
     */
     ...
     */
    public IntervalSum() {
        super("interval_sum", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL);
