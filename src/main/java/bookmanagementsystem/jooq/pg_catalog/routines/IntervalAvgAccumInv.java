...
public class IntervalAvgAccumInv extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.interval_avg_accum_inv._2</code>.
     */
     ...
     */
    public IntervalAvgAccumInv() {
        super("interval_avg_accum_inv", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
