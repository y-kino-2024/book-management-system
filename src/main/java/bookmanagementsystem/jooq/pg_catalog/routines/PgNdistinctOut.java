...
public class PgNdistinctOut extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_ndistinct\""), false, true);

    /**
     * Create a new routine call instance
     */
    public PgNdistinctOut() {
        super("pg_ndistinct_out", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
