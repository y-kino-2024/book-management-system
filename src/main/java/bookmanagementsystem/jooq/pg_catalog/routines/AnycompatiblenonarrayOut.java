...
public class AnycompatiblenonarrayOut extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anycompatiblenonarray\""), false, true);
    ...
    public AnycompatiblenonarrayOut() {
        super("anycompatiblenonarray_out", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
