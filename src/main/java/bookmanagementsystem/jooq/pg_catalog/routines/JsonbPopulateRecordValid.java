...
public class JsonbPopulateRecordValid extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.jsonb_populate_record_valid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.jsonb_populate_record_valid._2</code>.
     */
     ...
     */
    public JsonbPopulateRecordValid() {
        super("jsonb_populate_record_valid", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
