...
public class ToOct1 extends AbstractRoutine<String> {

    /**
     * The parameter <code>pg_catalog.to_oct.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);
    /**
     * The parameter <code>pg_catalog.to_oct._1</code>.
     */
     ...
     */
    public ToOct1() {
        super("to_oct", PgCatalog.PG_CATALOG, SQLDataType.CLOB);
