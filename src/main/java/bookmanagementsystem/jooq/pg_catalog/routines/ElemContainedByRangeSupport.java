...
public class ElemContainedByRangeSupport extends AbstractRoutine<Object> {
     ...
     */
    public ElemContainedByRangeSupport() {
        super("elem_contained_by_range_support", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
