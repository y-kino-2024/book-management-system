...
public class ArrayAggTransfn extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _2 = Internal.createParameter("_2", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anynonarray\""), false, true);

    /**
     * Create a new routine call instance
     */
    public ArrayAggTransfn() {
        super("array_agg_transfn", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
