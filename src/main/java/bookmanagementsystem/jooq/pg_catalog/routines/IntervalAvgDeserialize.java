...
public class IntervalAvgDeserialize extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.interval_avg_deserialize._1</code>.
     */
     ...
     */
    public IntervalAvgDeserialize() {
        super("interval_avg_deserialize", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
