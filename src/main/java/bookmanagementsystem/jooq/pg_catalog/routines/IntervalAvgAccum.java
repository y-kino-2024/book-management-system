...
public class IntervalAvgAccum extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.interval_avg_accum._2</code>.
     */
     ...
     */
    public IntervalAvgAccum() {
        super("interval_avg_accum", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
