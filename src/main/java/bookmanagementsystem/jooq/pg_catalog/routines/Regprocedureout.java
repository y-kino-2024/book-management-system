...
public class Regprocedureout extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regprocedure\""), false, true);

    /**
     * Create a new routine call instance
     */
    public Regprocedureout() {
        super("regprocedureout", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
