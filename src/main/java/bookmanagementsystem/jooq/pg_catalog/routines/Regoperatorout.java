...
public class Regoperatorout extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regoperator\""), false, true);

    /**
     * Create a new routine call instance
     */
    public Regoperatorout() {
        super("regoperatorout", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
