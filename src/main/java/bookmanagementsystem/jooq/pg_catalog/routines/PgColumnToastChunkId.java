...
public class PgColumnToastChunkId extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_column_toast_chunk_id.RETURN_VALUE</code>.
     */
     ...
     */
    public PgColumnToastChunkId() {
        super("pg_column_toast_chunk_id", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
