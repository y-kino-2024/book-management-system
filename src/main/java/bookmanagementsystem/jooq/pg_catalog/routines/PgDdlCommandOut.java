...
public class PgDdlCommandOut extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_ddl_command\""), false, true);

    /**
     * Create a new routine call instance
     */
    public PgDdlCommandOut() {
        super("pg_ddl_command_out", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
