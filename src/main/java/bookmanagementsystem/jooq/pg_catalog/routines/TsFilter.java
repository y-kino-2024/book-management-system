...
public class TsFilter extends AbstractRoutine<Object> {
     ...
     */
    public static final Parameter<String[]> _2 = Internal.createParameter("_2", SQLDataType.CHAR.array(), false, true);
     ...
     */
    public TsFilter() {
        super("ts_filter", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsvector\""));
