...
public class Aclremove extends AbstractRoutine<String[]> {
     ...
     */
    public static final Parameter<String[]> _1 = Internal.createParameter("_1", SQLDataType.VARCHAR.array(), false, true);
     ...
     */
    public Aclremove() {
        super("aclremove", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR.array());
