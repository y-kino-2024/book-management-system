...
public class AnynonarrayOut extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anynonarray\""), false, true);
    ...
    public AnynonarrayOut() {
        super("anynonarray_out", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
