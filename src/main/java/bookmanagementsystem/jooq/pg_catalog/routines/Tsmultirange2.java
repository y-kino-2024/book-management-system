...
public class Tsmultirange2 extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _1 = Internal.createParameter("_1", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsrange\""), false, true);
    ...
    public Tsmultirange2() {
        super("tsmultirange", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsmultirange\""));
