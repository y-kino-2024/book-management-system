...
import quoassignment.jooq.quo_assignment.tables.AuthorIndex.AuthorIndexPath;
...
public class AuthorsInfo extends TableImpl<AuthorsInfoRecord> {
     ...
     */
    public final TableField<AuthorsInfoRecord, LocalDate> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATE, this, "");
     ...
     */
    public final TableField<AuthorsInfoRecord, LocalDate> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATE, this, "");
