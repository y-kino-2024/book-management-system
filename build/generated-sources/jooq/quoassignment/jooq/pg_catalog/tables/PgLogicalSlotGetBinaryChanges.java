...
public class PgLogicalSlotGetBinaryChanges extends TableImpl<PgLogicalSlotGetBinaryChangesRecord> {
     ...
     */
    @Deprecated
    public final TableField<PgLogicalSlotGetBinaryChangesRecord, Object> LSN = createField(DSL.name("lsn"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""), this, "");
    ...
    private PgLogicalSlotGetBinaryChanges(Name alias, Table<PgLogicalSlotGetBinaryChangesRecord> aliased, Field<?>[] parameters, Condition where) {
